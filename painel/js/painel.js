...
(function () {
  ...
  function obterAbaVisivel() {
    ...
    const abaLogAtividades = document.getElementById("abaLogAtividades");
    if (abaLogAtividades && !abaLogAtividades.classList.contains("d-none")) return "abaLogAtividades";
